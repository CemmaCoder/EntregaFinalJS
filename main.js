...
// Agregar productos al carrito
        ...
        boton.addEventListener("click", () =>{
            Toastify({
                text: "Has agreado el carrito",
                duration: 3000,                                  // Duracion en milisegundos
                gravity: "top",                                  // Posicion del mensaje (DESDE)
                position: "right",                               // Posicion de salida del mensaje (A LA)
                style:{                                          // Dar estilo al boton
...
// Inicio de sesion SweetAlert
const inicioSesion = document.getElementById("inicioSesion");

inicioSesion.addEventListener("click", ()=> {
    Swal.fire({
        title: "Iniciar Sesion",
        html: ` <input type="text" id="email" class="swal2-input" placeholder="Email" required>
